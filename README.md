...
Projeto de automação de testes E2E (End-to-End) focado na aplicação [DemoQA](https://demoqa.com/), desenvolvido para cobrir cenários complexos de Frontend. A arquitetura foi desenhada visando **escalabilidade, manutenibilidade e resiliência**, aplicando padrões de automação, como o padrão estrutural Page Object Model (POM), massas de dados dinâmicas e validações avançadas de DOM.
